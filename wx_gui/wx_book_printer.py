...
class Book_printer(wx.Frame):
    def __init__(self, parent, id):
        ...
        wx.StaticText(self.panel, -1, 'Страниц в книге:', (10, 50), (150, 20))
        self.book_pages = wx.TextCtrl(self.panel, -1, '0', (160, 50), (50, 20))
        wx.StaticText(self.panel, -1, 'Страниц в тетраде:', (10, 70), (150, 20))
        self.part_pages = wx.TextCtrl(self.panel, -1, '32', (160, 70), (50, 20))

        self.btn_print = wx.Button(self.panel, -1, 'Печать', (10, 90), (200, 20))
